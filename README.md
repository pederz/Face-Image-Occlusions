...
2. Run the script!
   ...
   - NB! The script skips extracting features from a file if the biometric feature file already exist in `features/real/` or `features/synthetic/`. But this can be overwritten if `overwrite = True` in the first cell
